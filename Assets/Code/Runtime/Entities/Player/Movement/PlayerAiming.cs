...
public class PlayerAiming : MonoBehaviour
{
	...
	private void Update()
	{
		...
		// Input
		float xMovement = lookaction.ReadValue<Vector2>().x * horizontalSensitivity * sensitivityMultiplier;
		float yMovement = -lookaction.ReadValue<Vector2>().y * verticalSensitivity * sensitivityMultiplier;
