...
namespace SwapChains.Runtime.Entities.Player
{
    ...
    public class PhysicsMover : MonoBehaviour
    {
        ...
        /// </summary>
        public Vector3 InitialSimulationPosition { get; set; }

        /// <summary>
        /// The character's rotation before the movement calculations began
        /// </summary>
        public Quaternion InitialSimulationRotation { get; set; }
        ...
        public Vector3 TransientPosition
        {
            ...
            set => _internalTransientPosition = value;
        }
        ...
        public Quaternion TransientRotation
        {
            ...
            set => _internalTransientRotation = value;
        }
