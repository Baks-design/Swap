...
namespace SwapChains.Runtime.Entities.Player
{
    ...
    public class KinematicCharacterSystem : MonoBehaviour
    {
        ...
        /// </summary>
        public static void PreSimulationInterpolationUpdate(float _)
        {
            // Save pre-simulation poses and place transform at transient pose
            for (var i = 0; i < CharacterMotors.Count; i++)
            {
            ...
            for (var i = 0; i < PhysicsMovers.Count; i++)
            {
        ...
        static void CustomInterpolationUpdate()
        {
            ...
            for (var i = 0; i < PhysicsMovers.Count; i++)
            {
                ...
                mover.Transform.GetPositionAndRotation(out var newPos, out var newRot);
